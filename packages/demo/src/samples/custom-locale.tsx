...
export default function CustomLocale() {
    const [selected, setSelected] = useState(AVAILABLE_LOCALES[0]);

    return (
        <>
            <h1>Custom Locale</h1>
            <Chart width={600} height={300} localization={{ locale: selected }}>
                <LineSeries data={data}/>
            </Chart>
            <Switcher list={AVAILABLE_LOCALES} value={selected} onChange={(e) => setSelected(e.target.value)}/>
        </>
    )
}
