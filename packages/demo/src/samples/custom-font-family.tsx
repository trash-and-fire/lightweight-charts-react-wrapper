...
export default function CustomFontFamily() {
    const [selected, setSelected] = useState(AVAILABLE_FONTS[0]);

    return (
        <>
            <h1>Custom Font Family</h1>
            <Chart {...options} layout={{ fontFamily: selected }}>
                <AreaSeries
                    data={data}
            ...
            <Switcher list={AVAILABLE_FONTS} value={selected} onChange={(e) => setSelected(e.target.value)}/>
        </>
    )
}
